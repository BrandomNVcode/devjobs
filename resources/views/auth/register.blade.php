...
<div class="container mx-auto max-w-screen-md">
    <div class="flex flex-wrap justify-center">
                ...
                <div class="flex flex-col break-words bg-white border border-2 shadow-md mt-20">
                    ...
                    <form class="py-10 px-5" method="POST" action="{{ route('register') }}" novalidate>
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="name" type="text" class="p-3 bg-gray-200 rounded form-imput w-full @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" autocomplete="name" autofocus>
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="email" type="email" class="p-3 bg-gray-200 rounded form-imput w-full @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" autocomplete="email">
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="password" type="password" class="p-3 bg-gray-200 rounded form-imput w-full @error('password') is-invalid @enderror" name="password" autocomplete="new-password">
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="password-confirm" type="password" class="p-3 bg-gray-200 rounded form-imput w-full " name="password_confirmation" autocomplete="new-password">
                        </div>
        ...
        <div class="md:w-1/2 text-center flex flex-col justify-center order-1 md:order-2 px-10 mt-10">
