            ...
            <div class="flex flex-col break-words bg-white border border-2 shadow-md mt-20">
                ...
                <form class="py-10 px-5" method="POST" action="{{ route('login') }}" novalidate>
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="email" type="email" class="p-3 bg-gray-200 rounded form-imput w-full @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" autocomplete="email" autofocus>
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="password" type="password" class="p-3 bg-gray-200 rounded form-imput w-full @error('password') is-invalid @enderror" name="password" autocomplete="current-password">
